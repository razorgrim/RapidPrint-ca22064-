...
<body>
    <div class="sidepanel">
        ...
        <button onclick="window.location.href='admin_edit.php'">
            <i class="fas fa-edit"></i>
            <span>Edit Profile</span>
        </button>
        <form method="POST" action="admin_profile.php" onsubmit="return confirm('Are you sure you want to delete your profile?');">
